...
from .scholarships import ScholarshipDataViewSet,CategoryViewSet,UserScholarshipApplicationDataViewset,DocumentViewSet,EligibilityViewSet,UserScholarshipApplicationDataViewsetForAdmin,UserScholarshipApplicationDataViewsetForScholarshipProvider
